 ...
 *   https://datatables.net/download/#bs/jq-2.1.4,dt-1.10.10,se-1.1.0
 *
 * Included libraries:
 *   jQuery 2.1.4, DataTables 1.10.10, Select 1.1.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Apresentando _START_ a _END_ de _TOTAL_ registro(s).",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Apresentando 0 a 0 de 0 registro(s)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Apresentar _MENU_ registros",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/jq-2.1.4,dt-1.10.10,se-1.1.0",
