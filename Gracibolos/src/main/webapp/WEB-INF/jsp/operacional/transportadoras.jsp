...
<head>
	...
	<!-- Titulo da pÃ¡gina -->
	<title>Graci Bolos | Transportadoras</title>
...
<body>
		...
		<div class="row fullheight">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="clientes.jsp"><i class="material-icons">people</i>&nbsp;&nbsp;Clientes</a></li>
			...
			<div class="content fullpage col-xs-12 col-sm-12 col-md-9 col-lg-9">
				<div class="margin-top">
					...
					<header>
						<h2 class="">TRANSPORTADORAS</h2>
						<h4 class="">Lista de transportadoras</h4>
					</header>
					...
					<form action="" method="POST">
						...
						<div class="row">
							...
							<div class="input-margin col-xs-12 col-sm-12 col-md-12 col-md-lg-6">
								<label class="control-label">Pesquisar transportadoras:</label>
					...
					<div class="row">
						<div class="input-margin pull-right col-xs-12 col-sm-5 col-md-4">
							<a class="btn btn-default fullwidth" href="incluir_transportadora.jsp"><span class="glyphicon glyphicon-plus disabled"></span>&nbsp;&nbsp;&nbsp;Incluir nova transportadora</a>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Modal de confirmaÃ§Ã£o de exclusÃ£o de transportadora -->
	<div class="modal fade" id="excluirModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel">Excluir transportadora</h4>
	      </div>
	      <div class="modal-body">
	        <div>
	        	<p>Deseja realmente excluir a transportadora?</p>
	        </div>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">NÃ£o, quero excluir</button>
			<a href="" id="excluirTransportadora" class="btn btn-default">Sim, quero excluir</a>
	      </div>
	    </div>
	  </div>
	</div>
	...
	<script type="text/javascript">
		$( document ).ready(function() {
			...
			}).on("loaded.rs.jquery.bootgrid", function()
			{
				...
				{
					window.location="alterar_transportadora.html?id="+$(this).data("row-id");
				}).end().find(".command-delete").on("click", function(e)
				{
					$('#excluirModal').modal('show');

					$('#excluirTransportadora').attr("href","excluir_transportadora.html?id=" + $(this).data("row-id"));
				});
			});
