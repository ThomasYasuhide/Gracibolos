...
EstÃ¡ pagina foi criada com o intuito de poder alterar os dados cadastrais dos clientes da empresa.
...
<head>
	...
	<!-- DefeniÃ§Ã£o dos arquivos meta tags-->
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">

	<!-- ImportaÃ§Ã£o dos arquivos de estilo CSS -->
	...
	<!-- Titulo da pÃ¡gina -->
	<title>Graci Bolos | Alterar cliente</title>

</head>

<body>

	<!-- classe container-fluid define que o layout irÃ¡ ser ocupar 100% da largura da tela -->
	<!-- classe fullheight define que a pagina irÃ¡ ocupar 100% da altura da tela (EstÃ¡ clase Ã© uma dependente das filhas) -->
	<div class="container-fluid fullheight">

		<!-- classe row define que todo conteudo dentro da tag estÃ¡ em uma linha -->
		<!-- classe fullheight define que a pagina irÃ¡ ocupar 100% da altura da tela (EstÃ¡ clase Ã© uma dependente das filhas) -->
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
							<!-- Inicio dos links de navegaÃ§Ã£o -->
