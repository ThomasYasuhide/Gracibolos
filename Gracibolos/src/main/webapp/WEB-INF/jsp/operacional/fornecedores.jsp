		...
		<div class="row fullheight">
			...
			<div class="content fullpage col-xs-12 col-sm-12 col-md-9 col-lg-9">
				<div class="margin-top">
					...
					<!-- Essa div agrupa os campos de pesquisa e de listar os fornecedores -->
					<div class="row">
						<!-- Campo de pesquisar os fornecedores -->
						<div class="input-margin col-xs-12 col-sm-9 col-md-9 col-lg-9">
							...
							<form action="operacional-pesquisar-fornecedor" method="POST">
						...
						<!-- Esse botão lista todos os fornecedores -->
						<div class="input-margin col-xs-12 col-sm-3 col-md-3 col-lg-3">
							<label class="control-label hidden-xs">Listar fornecedores</label>
							<a href="operacional-listar-fornecedores" class="btn btn-default fullwidth">Listar fornecedores</a>
						</div>
					</div>
					...
					<div class="row">
						<div class="input-margin col-xs-12 col-sm-12 col-md-12 col-md-lg-6">
							<!-- tabela da lista de fornecedores  -->
								...
								<tbody>
									...
									<c:forEach var="fornecedor" items="${fornecedores}">
										<tr>
											...
											<!-- Aqui nessa td, estão os botões de editar e excluir, que aparecem junto com a lista de fornecedores na tabela -->
		                					<td>
		                						<button id="edit-fornecedor" class="btn btn-xs btn-default"><i class="material-icons font-xs">mode_edit</i></button>
		                						<button id="delete-fornecedor" class="btn btn-xs btn-default hidden"><i class="material-icons font-xs">clear</i></button>
		                					</td>
										</tr>
									</c:forEach>
								</tbody>
	...
	<div class="modal fade" id="modal-fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
	    		...
	    		<!-- formulário de preencher os dados do fornecedor -->
	    		<form id="fornecedor-form" method="POST">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="input-margin col-xs-12 col-sm-6 col-md-3">
									...
									<input type="text" id="bairro" name="bairro" placeholder="Digite seu bairro" class="form-control" maxlength="60" required disabled />
								</div>
					...
					<div class="modal-footer">
						...
						<!-- botão de incluir ou alterar o fornecedor, assim finalizando o formulário  -->
	...
	<div class="modal fade" id="excluir-fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form id="fornecedor-delete-form" action="operacional-remover-fornecedor" method="POST">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<!-- Essa div contem o id do fornecedor q vai ser excluido, porem ele fica escondido na tela, por causa da class hidden-->	
								<div class="hidden">
									<label class="control-label" for="id">Nº fornecedor:</label>
					...
					<div class="modal-footer">
						<!-- botão de cancelar a exclusão do fornecedor-->
						<button type="button" class="btn btn-default" data-dismiss="modal">Não, quero manter</button>
						<!-- botão de confirmar a exclusão do fornecedor -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			*/
			...
			//quando o usuário clica no botão de incluir novo fornecedor, ele abre o modal e chama essa função
            $('#incluir-fornecedor-modal').click(function() {
				...
				$("#fornecedor-form").attr("action","operacional-incluir-fornecedor");
			...
			*/
            ...
            $('#lista-fornecedores tbody').on( 'click', '#edit-fornecedor', function () {
            	...
            	//Altera o método de ação do form do modal (Altera para caso clicar no botão submit seja enviado a instrução de alteração).
				$("#fornecedor-form").attr("action","operacional-alterar-fornecedor");
