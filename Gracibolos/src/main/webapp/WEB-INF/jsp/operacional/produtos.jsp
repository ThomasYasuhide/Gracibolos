				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="produtos.jsp"><i class="material-icons">local_grocery_store</i>&nbsp;&nbsp;Produtos</a></li>
				...
				<div class="margin-top">
						...
						<div class="row">
							...
							<div class="input-margin col-xs-12 col-sm-12 col-md-12 col-md-lg-6">
								...
								<div class="input-group">
									<input type="text" class="form-control" maxlength="100" placeholder="Informe o cÃ³digo ou o nome do produto para realizar a pesquisa." name="pesquisa" id="pesquisa" required>
					...
					<table id="grid-basic" class="table table-hover">
						<thead>
							<tr>
								...
								<th data-column-id="codigo">CÃ³digo</th>
								<th data-column-id="produto">Produto</th>
					...
					<div class="row">
						<div class="input-margin pull-right col-xs-12 col-sm-5 col-md-3">
							<a class="btn btn-default fullwidth" href="incluir_produto.jsp"><span class="glyphicon glyphicon-plus disabled"></span>&nbsp;&nbsp;&nbsp;Incluir novo produto</a>
						</div>
					</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
			...
			<a href="" id="excluirProduto" class="btn btn-default">Sim, quero excluir</a>
	      </div>
	    </div>
	  </div>
	</div>
	...
	<script type="text/javascript">
		$( document ).ready(function() {
			...
			}).on("loaded.rs.jquery.bootgrid", function()
			{
				...
				{
					window.location="alterar_produto.html?id="+$(this).data("row-id");
				}).end().find(".command-delete").on("click", function(e)
				{
					$('#excluirModal').modal('show');

					$('#excluirProduto').attr("href","excluir_produto.html?id=" + $(this).data("row-id"));
				});
			});
