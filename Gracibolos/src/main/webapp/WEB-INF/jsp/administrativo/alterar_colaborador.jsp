...
<head>
	...
	<!-- Titulo da página -->
	<title>Graci Bolos | Alterar colaborador</title>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<form action="#" method="POST">
								...
								<div class="input-margin col-xs-12 col-sm-6 col-md-3">
									...
									<input type="text" class="form-control" name="username" id="username" maxlength="20" placeholder="Digite o seu usuário" required>
								</div>

								<div class="input-margin col-xs-12 col-sm-6 col-md-3">
									<label class="control-label" for="celular">Senha*:</label>
									<input type="password" class="form-control" name="password" id="password" maxlength="20" placeholder="Senha" required>
								</div>
								...
								<div class="input-margin col-xs-12 col-sm-12 col-md-12 text-right">
									<button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-floppy-disk disabled"></span>&nbsp;&nbsp;&nbsp;Alterar colaborador</button>
								</div>
							</form>
						</div>
					</div>
