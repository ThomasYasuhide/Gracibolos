...
<body>
				...
				<div class="margin-top">
					...
					<div class="row">
						<div class="input-margin pull-right col-xs-12 col-sm-5 col-md-3">
							<a class="btn btn-default fullwidth" href="incluir_fornecedor.jsp"><span class="glyphicon glyphicon-plus disabled"></span>&nbsp;&nbsp;&nbsp;Incluir novo fornecedor</a>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Modal de confirmação de exclusÃ£o de fornecedor -->
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
			...
			<a href="" id="excluirFornecedor" class="btn btn-default">Sim, quero excluir</a>
	      </div>
	    </div>
	  </div>
	</div>
		...
		$( document ).ready(function() {
			...
			}).on("loaded.rs.jquery.bootgrid", function()
			{
				...
				grid.find(".command-edit").on("click", function(e)
				{
					...
					window.location="alterar_fornecedor.html?id="+$(this).data("row-id");
				}).end().find(".command-delete").on("click", function(e)
				{
					$('#excluirModal').modal('show');

					$('#excluirFornecedor').attr("href","excluir_fornecedor.html?id=" + $(this).data("row-id"));
				});
			});
