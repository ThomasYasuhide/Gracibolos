...
<head>
	...
	<!-- Titulo da página -->
	<title>Graci Bolos | Incluir colaborador</title>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<form action="#" method="POST">
								...
								<div class="input-margin col-xs-12 col-sm-12 col-md-12 text-right">
									<button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-floppy-disk disabled"></span>&nbsp;&nbsp;&nbsp;Incluir colaborador</button>
								</div>
