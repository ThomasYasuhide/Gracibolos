					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<form action="#" method="POST">
								...
								<div class="input-margin col-xs-12 col-sm-6 col-md-3" id="nascimento">
									<label class="control-label" for="nascimento">Data de nascimento:</label>
									<input type="date" name="nascimento" class="form-control" name="nascimento" id="nascimento">
								</div>
								...
								<div class="input-margin col-xs-12 col-sm-9 col-md-4">
									...
									<input type="text" class="form-control" name="endereco" maxlength="120" id="endereco" placeholder="Digite aqui o seu endereço" required>
								</div>

								<div class="input-margin col-xs-12 col-sm-3 col-md-2">
									<label class="control-label" for="numero">Numero*:</label>
									<input type="number" class="form-control" maxlength="50" name="numero" id="numero" placeholder="Digite seu numero" required>
								</div>
