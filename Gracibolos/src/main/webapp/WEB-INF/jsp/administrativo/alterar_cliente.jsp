...
Está pagina foi criada com o intuito de poder alterar os dados cadastrais dos clientes da empresa.
...
<head>
	...
	<!-- Defenição dos arquivos meta tags-->
	<meta charset="utf-8">
...
<body>
	...
	<!-- classe container-fluid define que o layout irá ser ocupar 100% da largura da tela -->
	<!-- classe fullheight define que a pagina irá ocupar 100% da altura da tela (Está clase Ã© uma dependente das filhas) -->
	<div class="container-fluid fullheight">

		<!-- classe row define que todo conteudo dentro da tag está em uma linha -->
		<!-- classe fullheight define que a pagina irá ocupar 100% da altura da tela (Está clase Ã© uma dependente das filhas) -->
